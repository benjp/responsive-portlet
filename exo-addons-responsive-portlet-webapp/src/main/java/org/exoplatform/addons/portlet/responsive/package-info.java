@Assets(
        ...
        stylesheets = {
                @Stylesheet(src = "/org/exoplatform/addons/portlet/responsive/assets/responsive.css", location = AssetLocation.APPLICATION)
        }
)
...
@Portlet(name="ResponsivePortlet") package org.exoplatform.addons.portlet.responsive;
